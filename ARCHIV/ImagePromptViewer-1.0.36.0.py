...
"""
Datum: 2025-03-27
Versionsnummer: 1.0.36.0
Interne Bezeichnung: Master8 Alpha4

Änderungen in Version 1.0.36.0:
...
def extract_text_chunks(img_path):
        ...
        try:
            ...
            if user_comment and isinstance(user_comment, bytes):
                ...
                if user_comment.startswith(b"UNICODE\x00\x00"):
                    text_bytes = user_comment[8:]  # Überspringe die ersten 8 Bytes
                    encodings = [
                        ("utf-16le", "UTF-16LE"),
                        ("utf-16be", "UTF-16BE"),
                        ("utf-8", "UTF-8"),
    ...
    # Aufteilung in Prompt, Negativen Prompt und Settings
    ...
    if idx_steps != -1:
        # "Steps:" wird jetzt im Settings-Feld beibehalten
        settings = full_text[idx_steps:].strip()  # Änderung: "Steps:" bleibt enthalten
    else:
        settings = ""
