...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def setup_ui(self):
        ...
        # Button zum Laden der Ordnerliste
        self.load_list_button = tk.Button(self, text="Ordner-Liste laden", command=self.show_preview_table,
                                        bg=BTN_BG_COLOR, fg=BTN_FG_COLOR, font=("Arial", self.main_font_size))
    ...
    def safe_close_fullscreen(self):
        try:
            ...
            self.focus_force()
            # Zeige das zuletzt im Vollbild angezeigte Bild im Hauptfenster an
