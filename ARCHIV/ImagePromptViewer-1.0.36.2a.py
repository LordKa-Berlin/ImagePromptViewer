...
def extract_text_chunks(img_path):
    ...
    # Aufteilen in Prompt, Negativen Prompt und Settings
    # Marker: "Negative prompt:" und "Steps:"
...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def show_info(self):
        ...
        info_text = (
            ...
            "Git-Aktualisierungshinweis:\n"
            "  • Nach Änderungen am Script führen Sie die entsprechenden Git-Befehle aus, um die neue Version in den Repositories zu aktualisieren.\n\n"
