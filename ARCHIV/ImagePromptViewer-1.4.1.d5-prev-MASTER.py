...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def setup_ui(self):
        ...
        custom_date_frame3 = tk.Frame(date_frame, bg=BG_COLOR)
        custom_date_frame3.pack(fill="x", padx=10, pady=2)
        tk.Label(custom_date_frame3, text="Between dates (YYYY-MM-DD):", bg=BG_COLOR, fg=TEXT_FG_COLOR, font=("Arial", self.main_font_size)).pack(side="left")
        self.entry_start_date = tk.Entry(custom_date_frame3, bg="#000000", fg=TEXT_FG_COLOR, insertbackground=TEXT_FG_COLOR, width=10)
        self.entry_start_date.pack(side="left", padx=5)
        tk.Label(custom_date_frame3, text="and", bg=BG_COLOR, fg=TEXT_FG_COLOR, font=("Arial", self.main_font_size)).pack(side="left")
        self.entry_end_date = tk.Entry(custom_date_frame3, bg="#000000", fg=TEXT_FG_COLOR, insertbackground=TEXT_FG_COLOR, width=10)
