...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def setup_ui(self):
        ...
        # Neuer Frame für den Prompt Filter
        self.left_filter_frame = tk.Frame(self, bg=BG_COLOR)
        self.left_filter_frame.pack(side="left", fill="y", padx=self.button_padding, pady=self.button_padding)
        self.left_date_filter_frame = tk.Frame(self, bg=BG_COLOR)
        self.left_date_filter_frame.pack(side="left", fill="y", padx=self.button_padding, pady=self.button_padding)
       ...
       ##xx
        ...
        self.image_frame.pack(side="right", fill="both", expand=True, padx=self.button_padding, pady=self.button_padding)
