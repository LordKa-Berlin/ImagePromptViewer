...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def setup_ui(self):
        ...
        # Erstelle einen Hauptcontainer, in dem zwei nebeneinander liegende Bereiche entstehen:
        # links: Filter Settings; rechts: Bildanzeige
        ...
        # Neuer linker Bereich: Filter Settings (inkl. Prompt, Date, File Size und Buttons)
        filter_frame = tk.Frame(main_container, bg=BG_COLOR)
        filter_frame.pack(side="left", fill="y", padx=self.button_padding, pady=self.button_padding)

        # --- In diesen Filterbereich verschieben wir den gesamten Inhalt, der bisher im separaten Filter Settings Panel war ---
        # Prompt Filter Section
        prompt_frame = tk.LabelFrame(filter_frame, text="Prompt Filter", fg=TEXT_FG_COLOR, bg=BG_COLOR,
        ...
        # Date Filter Section
        date_frame = tk.LabelFrame(filter_frame, text="Date Filter", fg=TEXT_FG_COLOR, bg=BG_COLOR,
                                   font=("Arial", int(self.main_font_size * 1.2), "bold"))
        ...
        size_frame = tk.LabelFrame(filter_frame, text="File Size (KB)", fg=TEXT_FG_COLOR, bg=BG_COLOR,
                                   font=("Arial", int(self.main_font_size * 1.2), "bold"))
        ...
        # (Kein "Close"-Button, da das Panel dauerhaft sichtbar sein soll)

        # Linke Spalte (Filterbereich) fertig – nun folgt der rechte Bereich: Bildanzeige

        # Bildanzeige: Dieser Frame wird rechts im main_container platziert
        self.image_frame = tk.Frame(main_container, bg=BG_COLOR)
        ...
        # Restliche Elemente unterhalb des Hauptcontainers (Navigation, Controls, Textchunks, Preview)
