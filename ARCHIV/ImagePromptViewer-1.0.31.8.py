...
Änderungen in Version 1.0.31.8:
...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def __init__(self):
        ...
        self.filter_settings_var = tk.BooleanVar(value=False)  # Neu: Settings-Filter
    ...
    def update_fs_info_fullscreen(self):
        ...
        # Hinweis "FILTER AKTIV!" hinzufügen, wenn gefiltert
