...
Änderungen in Version 1.0.31.11:
- Fehler in tk.OptionMenu command behoben: self.rescale_image korrekt als Callback übergeben.
...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def __init__(self):
        ...
        # Korrektur: command als Callback mit Wert als Argument
    ...
    def show_filter_history(self, event):
        ...
        menu.post(self.filter_entry.winfo_rootx(), self.filter_entry.winfo_rooty() + self.filter_entry.winfo_height())
