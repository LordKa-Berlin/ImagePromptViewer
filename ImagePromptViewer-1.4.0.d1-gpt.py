...
def get_window_size(monitor):
    window_width = int(monitor.width * 0.9)
...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def setup_ui(self):
        ...
        # Erstelle einen Container für die Steuerungsbereiche (links: alte Steuerelemente; rechts: Filter Settings Panel)
        controls_container = tk.Frame(self, bg=BG_COLOR)
        controls_container.pack(fill="x", padx=self.button_padding, pady=self.button_padding)
        left_controls = tk.Frame(controls_container, bg=BG_COLOR)
        left_controls.pack(side="left", fill="x", expand=True)
        right_controls = tk.Frame(controls_container, bg=BG_COLOR)
        right_controls.pack(side="right", fill="y")

        # Linke Spalte: Bestehende Steuerelemente (ohne den alten Filter Settings Button)
        # Filter Frame
        filter_frame = tk.Frame(left_controls, bg=BG_COLOR)
        ...
        # (Der alte Button "Filter Settings" entfällt jetzt!)
        ...
        # Folder Frame
        folder_frame = tk.Frame(left_controls, bg=BG_COLOR)
        ...
        # Subfolder Frame
        subfolder_frame = tk.Frame(left_controls, bg=BG_COLOR)
        ...
        # Rechte Spalte: Integriertes Filter Settings Panel
        self.filter_settings_frame = tk.Frame(right_controls, bg=BG_COLOR, bd=2, relief="groove")
        self.filter_settings_frame.pack(fill="both", padx=self.button_padding, pady=self.button_padding)
        # Prompt Filter Section
        prompt_frame = tk.LabelFrame(self.filter_settings_frame, text="Prompt Filter", fg=TEXT_FG_COLOR, bg=BG_COLOR,
        ...
        # Date Filter Section
        date_frame = tk.LabelFrame(self.filter_settings_frame, text="Date Filter", fg=TEXT_FG_COLOR, bg=BG_COLOR,
                                   font=("Arial", int(self.main_font_size * 1.2), "bold"))
        ...
        size_frame = tk.LabelFrame(self.filter_settings_frame, text="File Size (KB)", fg=TEXT_FG_COLOR, bg=BG_COLOR,
                                   font=("Arial", int(self.main_font_size * 1.2), "bold"))
        ...
        # Button Frame im Filter Settings Panel
        button_frame = tk.Frame(self.filter_settings_frame, bg=BG_COLOR)
        ...
        # (Kein Close-Button, da das Panel dauerhaft sichtbar ist)

        # Restliche Elemente: Image Frame, Navigation, Controls, Textchunks, Preview etc.
        # (Diese werden unverändert unterhalb der Steuerungsbereiche gepackt)
        image_frame = tk.Frame(self, bg=BG_COLOR)
        image_frame.pack(fill="both", expand=True, padx=self.button_padding, pady=self.button_padding)
        self.image_frame = image_frame
        self.image_label = tk.Label(image_frame, bg=BG_COLOR)
        ...
        self.drop_canvas = tk.Canvas(image_frame, width=int(150 * self.scaling_factor), height=int(112 * self.scaling_factor),
