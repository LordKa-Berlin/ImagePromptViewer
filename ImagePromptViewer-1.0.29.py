...
Änderungen in Version 1.0.29:
- Beim Droppen eines Bildes wird automatisch der gesamte Ordner eingelesen und in die Liste geladen.
"""
...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def handle_drop(self, event):
        ...
        if os.path.isfile(file_path):
            # Extrahiere den Ordnerpfad aus dem gedroppten Bild
            folder = os.path.dirname(file_path)
            # Setze den Ordnerpfad in das Eingabefeld
            self.folder_path_var.set(folder)
            # Lese alle PNG-Dateien aus dem Ordner ein
            ...
            # Setze den Index auf das gedropte Bild
