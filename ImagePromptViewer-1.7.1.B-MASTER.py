...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def load_folder_async(self, folder, file_path=None):
            ...
            def worker():
                # Erzeuge einen Generator: Bei Unterordnern rglob, sonst einfachen Inhalt
                ...
                for p in generator:
                    ...
                    # Wenn ein Chunk voll ist, füge ihn im UI-Thread hinzu
                    if total % chunk_size == 0:
                        self.after(0, lambda c=chunk: self.folder_images.extend(c))
                        # Optionale Statusaktualisierung alle 100 Dateien
