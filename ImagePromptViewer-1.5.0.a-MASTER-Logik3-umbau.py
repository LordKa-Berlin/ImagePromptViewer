...
def extract_text_chunks(img_path):
    ...
    # Logik 3: Suche nach speziellen Markern für ComfyUI-Workflow mit Regex
    try:
        ...
        if matches:
            ...
            if prompt_regex or negativ_regex:
                settings_regex = ""  # Settings bleibt leer, wie in deinem ursprünglichen Code
                debug_info.append("Debug: ComfyUI marker extraction successful.")
