...
"""
Datum: 2025-03-25
Versionsnummer: 1.0.35.5
Interne Bezeichnung: Master 3 Alpha 1

Änderungen in Version 1.0.35.5:
- Fehlerbehebung bei der Extraktion von Textchunks aus JPEG-Dateien:
  - Dekodierung der EXIF-Daten mit ANSI (`cp1252`) anstelle von `utf-16`, `utf-8` oder `latin-1`.
            ...
            for ifd in exif_dict:
                for tag in exif_dict[ifd]:
                    ...
                    if isinstance(value, bytes) and b"UNICODE" in value:
                        # Versuche, den Wert als ANSI (cp1252) zu dekodieren
                        try:
