...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def setup_ui(self):
        ...
        # Korrektur: Verwende Combobox statt Entry
        folder_combo_font_size = int(self.main_font_size * 0.9)
        style.configure("Folder.TCombobox", font=("Arial", folder_combo_font_size))
        self.folder_combo = ttk.Combobox(folder_frame, textvariable=self.folder_path_var, style="Folder.TCombobox", width=int(50 * self.scaling_factor))
