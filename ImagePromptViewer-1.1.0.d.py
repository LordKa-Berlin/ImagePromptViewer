...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def toggle_sort_order(self):
        ...
        if self.folder_images:
            ...
            if self.filtered_images:
                ...
                self.display_image_async(self.filtered_images[self.current_index])
    ...
    def apply_filter(self):
        ...
        if filter_text_raw and filter_text_raw not in self.filter_history:
            self.filter_history.append(filter_text_raw)
    ...
    def display_image_async(self, file_path, default_scale=False):
        self.after(0, lambda: self.display_image(file_path, default_scale))
    ...
    def show_fullscreen(self):
        ...
        self.fs_image_path = self.current_image_path
        if self.fs_image_path in self.filtered_images:
            self.fs_current_index = self.filtered_images.index(self.fs_image_path)
        else:
            self.fs_current_index = 0
