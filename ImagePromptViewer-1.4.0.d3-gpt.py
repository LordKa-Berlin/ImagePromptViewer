...
def setup_ui(self):
    ...
    # Hauptcontainer: horizontal in zwei Spalten aufteilen
    ...
    # Linke Spalte: Neuer integrierter Filter Settings Panel (enthält Prompt, Date, File Size und Buttons)
    ...
    # --- Integrierter Filter Settings Bereich:
    ...
    # Kein Close-Button, da dieses Panel dauerhaft sichtbar sein soll.

    # Rechte Spalte: Bestehende Steuerelemente (Filter-Button, Folderpath, Subfolder)
    ...
    # Filter Frame (ohne Filter Settings Button)
