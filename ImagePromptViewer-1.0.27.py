...
class ImageManagerForm(TkinterDnD.Tk):
    def __init__(self):
        ...
        self.scale_dropdown.configure(bg=BTN_BG_COLOR, fg=BTN_FG_COLOR, font=("Arial", self.main_font_size))
        ...
        if len(self.monitor_list) > 1:
            ...
            self.monitor_menu.configure(bg=BTN_BG_COLOR, fg=BTN_FG_COLOR, font=("Arial", self.main_font_size))
