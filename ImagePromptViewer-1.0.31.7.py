...
Änderungen in Version 1.0.31.7:
...
- Filter-Textfeld und Kontrollfelder (Dateiname, Prompt, Negativ Prompt) über Ordnerpfad hinzugefügt.
...
def extract_png_text_chunks(png_path):
    ...
    6. Gibt die drei Teile als Tuple zurück und loggt Debugging-Informationen.
...
class ImageManagerForm(TkinterDnD.Tk):
    ...
    def apply_filter(self):
        ...
        if not filter_text:
            ...
            for file_path in self.folder_images:
                ...
                prompt, negativ, _ = extract_png_text_chunks(file_path)
                prompt = prompt.lower()
    ...
    def show_info(self):
        ...
        info_text = (
            ...
            "Filter: Filtert Bilder nach Dateiname, Prompt und Negativ Prompt.\n"
        )
