...
"""
Datum: 2025-03-25
Versionsnummer: 1.0.35.1
Interne Bezeichnung: Master 3 Alpha 1

Änderungen in Version 1.0.35.1:
- Unterstützung für JPEG-Dateien hinzugefügt:
  - JPEG-Dateien werden nun eingelesen (Erweiterungen .jpg, .jpeg).
  - Textchunks in JPEG-Dateien werden mit dem Marker "UNICODE" extrahiert.
  - Die gleiche Logik wie bei PNG-Dateien (Trennstellen: "Negative prompt:", "Steps:") wird angewendet.
- Dynamische Skalierung im Hauptformular angepasst:
  - Bilder mit großen Auflösungen (z. B. 3076x5600) werden nun an den verfügbaren Anzeigebereich angepasst.
  - Maximale Größe auf 80 % der Breite und Höhe des Anzeigebereichs begrenzt.
...
IMAGE_EXTENSIONS = (".png", ".PNG", ".jpg", ".JPG", ".jpeg", ".JPEG")  # Unterstützung für JPEG hinzugefügt
